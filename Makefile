...
TESTS = lexer_from_example_foo lexer_from_str_foo lexer_two_plus_two_mul_two
TEST_BINS = $(addprefix tests/, $(TESTS))
TEST_OBJS = $(addsuffix .c.o, $(TEST_BINS))

.PHONY: all clean test test_lexer_from_example_foo test_lexer_from_str_foo test_lexer_two_plus_two_mul_two
